...
public function eliminar(Request $request)
{
    ...
    $rubro = new Rubro();
    // Si el rubro tiene pedidos asociados, no se debe poder eliminar
    if ($rubro->existePedidosPorRubro($idrubro)) {
        $resultado["err"] = EXIT_FAILURE;
        $resultado["mensaje"] = "No se puede eliminar un rubro con pedidos asociados";
    } else {
        $proveedor = new Proveedor();
        $proveedor->idproveedor = $idrubro;
        $proveedor->eliminar();
