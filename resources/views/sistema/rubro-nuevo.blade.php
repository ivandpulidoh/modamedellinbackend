...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item"><a href="/admin/rubro">Rubro</a></li>
	<li class="breadcrumb-item active">Modificar</li>
</ol>
<ol class="toolbar">
	<li class="btn-item"><a title="Nuevo" href="/admin/sistema/rubro/nuevo" class="fa fa-plus-circle" aria-hidden="true"><span>Nuevo</span></a></li>
