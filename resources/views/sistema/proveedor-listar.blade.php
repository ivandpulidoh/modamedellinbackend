...
<ol class="toolbar">
    ...
    <li class="btn-item"><a title="Recargar" href="#" class="fas fa-sync-alt" aria-hidden="true" onclick='window.location.replace("/admin/proveedores");'><span>Recargar</span></a></li>
</ol>
