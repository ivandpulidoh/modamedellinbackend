				...
				<nav class="navbar navbar-expand-lg custom_nav-container ">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mx-auto">
							...
							<li class="nav-item {{ Request::url() == url('/takeway') ? 'active' : '' }}">
								<a class="nav-link" href="/takeway">TAKEWAY</a>
							</li>
							<li class="nav-item {{ Request::url() == url('/nosotros') ? 'active' : '' }}">
								<a class="nav-link" href="/nosotros">NOSOTROS</a>
							</li>
							<li class="nav-item {{ Request::url() == url('/contacto') ? 'active' : '' }}">
